...
const VENUE_DETAIL_COPY = {
  en: {
    ...
    missingSubtitle: 'The requested place could not be found.',
    missingBadge: 'MISSING PLACE',
    missingTitle: 'Missing place',
    missingDescription: 'Return to the place catalog and open another card.',
    backToVenues: 'Back to Places',
    subtitle: 'Place profile with reusable cost items for transaction setup.',
    menuItems: 'COST ITEMS',
    venueCard: 'Place card',
    noAddress: 'No address yet',
    openUntil: 'Available until',
    addMenuItem: 'Add Cost Item',
    items: 'Items',
    itemsHint: 'Current cost items saved locally',
    averagePrice: 'Average Price',
    averageHint: 'Rough place benchmark',
    menuCatalog: 'Price List',
    allItems: 'Stored cost items',
    catalogDescription: 'Tap add item to grow the reusable price list for this place.',
    emptyTitle: 'No cost items yet',
    emptyDescription: 'Add the first fee, rental, dish, or service to use this place faster.',
    editItem: 'Edit item',
  ...
  vi: {
    ...
    subtitle: 'Thông tin địa điểm và bảng giá dùng để điền nhanh khi tạo giao dịch.',
    menuItems: 'MỤC CHI PHÍ',
    venueCard: 'Thẻ địa điểm',
    noAddress: 'Chưa có địa chỉ',
    openUntil: 'Hoạt động đến',
    addMenuItem: 'Thêm mục chi phí',
    items: 'Số mục',
    itemsHint: 'Các mục chi phí đang được lưu cục bộ',
    averagePrice: 'Giá trung bình',
    averageHint: 'Mức giá tham khảo của địa điểm',
    menuCatalog: 'Bảng giá',
    allItems: 'Tất cả mục chi phí đã lưu',
    catalogDescription: 'Thêm mục chi phí để dùng nhanh khi tạo giao dịch.',
    emptyTitle: 'Chưa có mục chi phí',
    emptyDescription: 'Thêm phí sân, món ăn, đồ uống hoặc dịch vụ đầu tiên để điền nhanh.',
    editItem: 'Sửa mục',
    deleteItem: 'Xóa mục',
