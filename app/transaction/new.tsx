...
const NEW_TRANSACTION_COPY = {
  en: {
    ...
    subtitle: "Create a shared debit with reusable cost items, member-level discounts, and split totals.",
    badge: "NEW DEBIT",
    ...
    venue: "Place",
    selectVenue: "Select place - optional",
    noVenue: "No place",
    noVenues:
      "No places saved yet. You can continue without one or add a place for quick cost choices.",
    addVenue: "Add Place",
    members: "Members",
    ...
    orderDetails: "Cost details",
    memberOrders: "Member cost items",
    addOrder: "Add item",
    removeOrder: "Remove item",
    removeMember: "Remove member",
    dishLabel: (index: number) => `Item ${index}`,
    noOrders: "Select at least one member to add cost rows.",
    ...
    amountError:
      "Enter an amount for each selected member item, or turn on share with a total amount so the remaining bill can be assigned.",
    save: "Save Transaction",
  },
  vi: {
    menuItems: (count: number) => `${count} mục chi phí`,
    shareFromRemaining: (amount: string) => `Phần chia từ số tiền còn lại: ${amount}`,
    totalDue: (amount: string) => `Tổng cần trả: ${amount}`,
    itemOptional: "Mục chi phí - tùy chọn",
    selectItem: "Chọn mục",
    noMenuItems: "Chưa có mục chi phí",
    noItem: "Không chọn mục",
    closeItemPicker: "Đóng danh sách mục",
    selectedItems: (count: number) => `${count} mục đã chọn`,
    applyItems: "Áp dụng mục",
    itemName: "Tên mục",
    ...
    title: "Tạo giao dịch",
    subtitle: "Tạo khoản chi chung với mục chi phí, giảm giá theo thành viên và tổng tiền chia.",
    badge: "KHOẢN CHI MỚI",
    ...
    noVenues: "Chưa lưu địa điểm. Bạn có thể tiếp tục hoặc thêm địa điểm để chọn mục chi phí nhanh.",
    ...
    orderDetails: "Chi tiết chi phí",
    memberOrders: "Mục chi phí của thành viên",
    addOrder: "Thêm mục",
    removeOrder: "Xóa mục",
    removeMember: "Xóa thành viên",
    dishLabel: (index: number) => `Mục ${index}`,
    noOrders: "Chọn ít nhất một thành viên để thêm mục chi phí.",
    ...
    amountError:
      "Nhập tiền cho mục chi phí của từng thành viên, hoặc nhập tổng tiền và bật chia để phân bổ phần còn lại.",
    save: "Lưu giao dịch",
  },
} as const;
